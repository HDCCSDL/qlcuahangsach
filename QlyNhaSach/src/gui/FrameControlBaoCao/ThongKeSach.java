...
public class ThongKeSach extends JFrame {
	...
	public ThongKeSach() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(GUI.jLogin.class.getResource("/data/img/report.png")));
		...
		bThongKe.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(rbTKS.isSelected()){
					MyReportViewer viewer=new MyReportViewer("/mnt/DATA/BTL_CSDL/Qly Nha Sach/src/Report/rp_Sach.jasper");
			        viewer.setVisible(true);
				}
				if(rbTKT.isSelected()){
					ReportThongKeNhapXuat viewer = new ReportThongKeNhapXuat("/mnt/DATA/BTL_CSDL/Qly Nha Sach/src/Report/rp_TkSachTheoThang.jasper");
					viewer.setVisible(true);
				}
				if(rbTKN.isSelected()){
					ReportThongKeSachTheoNam viewer = new ReportThongKeSachTheoNam("/mnt/DATA/BTL_CSDL/Qly Nha Sach/src/Report/rp_TkSachTheoNam.jasper");
					viewer.setVisible(true);
				}
			}
		});
