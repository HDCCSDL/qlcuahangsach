...
public class ThongTin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Build and Copyright by Hespi K58");

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jLabel5.setText("Viện Công Nghệ Thông Tin và Truyền Thông");

        jList1.setFont(new java.awt.Font("Times New Roman", 1, 15)); // NOI18N
        jList1.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Tác giả: Phạm Đình Chiến", "Phạm Tất Đạt" };
