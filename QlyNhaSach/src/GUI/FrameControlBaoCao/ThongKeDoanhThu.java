		...
		bThongKe.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				if(rbTKTLT.isSelected()){
					ReportTkTienLoiThang viewer = new ReportTkTienLoiThang("/mnt/DATA/BTL_CSDL/Qly Nha Sach/src/Report/rp_TkTienLoiThang.jasper");
					viewer.setVisible(true);
				}
				if(rbTKTLN.isSelected()){
					ReportTkTienLoiNam viewer = new ReportTkTienLoiNam("/mnt/DATA/BTL_CSDL/Qly Nha Sach/src/Report/rp_TkTienLoiNam.jasper");
					viewer.setVisible(true);
					
				}
				if(rbTKDT.isSelected()){
					ReportThongKeDoanhThu viewer = new ReportThongKeDoanhThu("/mnt/DATA/BTL_CSDL/Qly Nha Sach/src/Report/rp_TKDT.jasper");
					viewer.setVisible(true);
				}
			}
		});
